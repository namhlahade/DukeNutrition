...
cursor.execute("create table User_Meal (user_meal_id text, user_id text, pref_id text, meal_id text, meal_date datetime, FOREIGN KEY (user_id) REFERENCES User_Table(user_id), FOREIGN KEY (pref_id) REFERENCES User_Pref(pref_id))")
